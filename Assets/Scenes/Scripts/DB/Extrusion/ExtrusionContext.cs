...
namespace Database
{
    ...
    {
        const string DefaultConnectStr = "Host=localhost;Port=5433;Database=Extrusion;Username=postgres;Password=user";
        const string ConnectFile = "ExtrusionConnectionString.cfg";
